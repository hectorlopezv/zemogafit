    ...
    <div className="max-centered">
      <div className="hero__featured-card">
        ...
        <div className="featured-card__content">
          ...
          <p className="featured-card__more-info" aria-label="more info about pope francisco in wikipedia">
            <a href="https://www.google.com" aria-label="more info about pope francisco in wikipedia">
              <svg
                className="featured-card__more-info-icon"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 27 18"
                aria-label="more info about pope francisco in wikipedia"
              >
                <path
          ...
          <div className="featured-card__buttons">
            <button className="icon-button" aria-label="thumbs up">
              <Image src="/assets/img/thumbs-up.svg" height={16} width={16} alt="thumbs up" />
            </button>
            <button className="icon-button" aria-label="thumbs down">
              <Image src="/assets/img/thumbs-down.svg" height={16} width={16} alt="thumbs down" />
            </button>
          </div>
        </div>
      </div>
